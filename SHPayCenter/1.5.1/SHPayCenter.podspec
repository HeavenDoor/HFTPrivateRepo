Pod::Spec.new do |s|
  ...
  s.source_files = 'SHPayCenter/Classes/*.{h,m}','SHPayCenter/Classes/PayResultReverter/*.{h,m}','SHPayCenter/Classes/PayParamsGenerator/*.{h,m}','SHPayCenter/Classes/PayParamsGenerator/MapParamsGenerator/*.{h,m}'
